...
function ChartContainer({ id, className, children, config, ...props }) {
    ...
    return (<ChartContext.Provider value={{ config }}>
      <div data-slot="chart" data-chart={chartId} className={cn("[&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-grid_line[stroke='#b6b1c0']]:stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-border [&_.recharts-polar-grid_[stroke='#b6b1c0']]:stroke-border [&_.recharts-radial-bar-background-sector]:fill-muted [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-muted [&_.recharts-reference-line_[stroke='#b6b1c0']]:stroke-border flex aspect-video justify-center text-xs [&_.recharts-dot[stroke='#f6f6f6']]:stroke-transparent [&_.recharts-layer]:outline-hidden [&_.recharts-sector]:outline-hidden [&_.recharts-sector[stroke='#f6f6f6']]:stroke-transparent [&_.recharts-surface]:outline-hidden", className)} {...props}>
